...
func NewBitmap(data []byte) (*Bitmap, int, error) {
	...
	bm := &Bitmap{
		primary: binary.BigEndian.Uint64(data[0:8]),
	}
...
// Bytes returns the bitmap as 8 or 16 bytes depending on whether secondary is present.
